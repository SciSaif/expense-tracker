...
function Add() {
  ...
  return (
    <div className="w-full p-3 bg-white rounded mb-5 shadow-2xl pt-6 px-10">
      <div className="flex flex-row items-center mb-4">
        <div className="font-semibold mr-3">Total Expense: </div>
        <div className="text-lg text-red-400 font-bold">$ {totalExpense}</div>
      </div>
      <div
        className="text-2xl flex flex-row p-3 bg-violet-200 rounded-full justify-center items-center cursor-pointer hover:bg-violet-300"
        onClick={handleClick}
      >
          ...
          <div className="mt-5">
            <div className="flex flex-col mb-2">
              ...
              <input
                ...
                className=" mt-2   bg-violet-100 rounded-xl px-5 py-2 shadow-lg"
                value={title}
                onChange={onChange}
              />
            </div>
            ...
            <div className="flex flex-row items-end justify-between">
              <div className="flex flex-col mb-2">
                ...
                <input
                  ...
                  className="min-w-[50px] mt-2 min-h-[50px] text-lg bg-green-100 rounded-xl px-5 shadow-lg"
                  value={amount}
                  onChange={onChange}
                />
              </div>
            ...
            <div className="w-full flex justify-end mt-2">
              <button
                type="submit"
                className="px-10 py-3 text-lg bg-green-300 rounded-xl shadow-md"
              >
                {mode === "add" ? "Add" : "Edit"}
              </button>
            </div>
